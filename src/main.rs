...
fn main() -> ! {
    ...
    let mut rf_data_tx = gpioa.pa0.into_push_pull_output(&mut gpioa.crl);
    let mut rf_data_rx = gpioa.pa1.into_pull_down_input(&mut gpioa.crl);
